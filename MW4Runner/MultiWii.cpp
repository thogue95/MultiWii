...
void annexCode() { // this code is excetuted at each loop and won't interfere with control loop if it lasts less than 650 microseconds
 ...
 /*
  ...
  SerialPrint(0,"AnnexCode: running telemetryData()\n");
  telemetryData(); 
...
//*****************************************************/
#if defined(DEBUG)
  SerialPrint(0,"Completed Arming\n");
  SerialPrint(0, "Alarms: ");
...
/*****************************/   
  ...
  if ((int16_t)(currentTime-rcTime) >0 ) { // 50Hz
   ...
   //Walkera Wing LED Bars
  if (rcData[ROLL] <= 1400)  {
          
          LWLED_ON;
  } else if  (rcData[ROLL] >= 1550) {
          RWLED_ON;
