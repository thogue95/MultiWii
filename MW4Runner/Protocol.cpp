...
/*
#if defined(DEBUG)
  SerialPrint(0,"Protocol: Sending RAW GPS Telemetry Data:\n");
   //SerialPrint(0,port);
  // SerialPrint(0,"SerialCom: Current port:");

   //MSP_ATTITUDE
   //MSP_COMP_GPS
   // MSP_RAW_GPS
  telemetryFlag = 1;
  tmpMspCmd = MSP_RAW_IMU;
    CURRENTPORT = 0;
    evaluateCommand(tmpMspCmd);
...
//  #if defined(DEBUG)
 // SerialPrint(0,"Evaluating MSP Command\n");
  //SerialPrint(0, "Command = % ");

  //SerialPrint(0, itoa(ALRM_FAC_ACC, tmpAlarmChar, 0));
