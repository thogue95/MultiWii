...
/*************************************************************************************************/
  ...
  /****************************    Motor minthrottle    *******************************/
    ...
    //#define MINTHROTTLE 1150 // (*) (**)  //default
    //#define MINTHROTTLE 1110// (*) (**)  //walkera
     #define MINTHROTTLE 1150// (*) (**)  //walkera
  /****************************    Motor maxthrottle    *******************************/
  ...
  /****************************    Mincommand          *******************************/
    /* this is the value for the ESCs when they are not armed
       ...
       //walkera...changed to 900 as sometimes motors would keep spinning
  ...
  /**************************************************************************************/
    ...
    /***************************    Combined IMU Boards    ********************************/
      ...
      #define Walkera_Runner  //Walkera Advance Runner 250. Should work with the basic runners too but it won't have GPS, Mag, or Barometer
  ...
  /**************************************************************************************/
    ...
    /*********************    Lowpass filter for some gyros    ****************************/
     ...
     // #define GYRO_LPF_98HZ
        #define GYRO_LPF_42HZ  //setting for Walkera---worked best
 ...
 */
  ...
  /**************************************************************************************/
    ...
    //Walkera...this is set in the def.h     
   // #define GPS_SERIAL 2         // should be 2 for flyduino v2. It's the serial port number on arduino MEGA
    ...
    //#define GPS_SERIAL 3 //Walkera put GPS on UART 2 which maps to Serial 3
   ...
   /* GPS protocol 
    ...
    //#define NMEA
    //#define UBLOX  // for Walkera set in def.h
    //#define MTK_BINARY16
    //#define MTK_BINARY19
...
#define LAND_SPEED          100
  ...
  /********************************************************************/
     ...
     */
    #define BOARD_NAME "Runner250_______"
    //                  123456789.123456
